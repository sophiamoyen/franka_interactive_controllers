...
def get_y_t(self, q=None, qd=None, qdd=None, **params):
...
class FullProMP:
    ...
    def __M_step(self, times, Y, expectations, **args):
        Phi = self.__get_Phi(times, **args)
        N = len(times)
        w_means = expectations['w_means'] # from E-step
        w_covs = expectations['w_covs'] # from E-step
